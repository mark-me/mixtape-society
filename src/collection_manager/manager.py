...
class CollectionManager:
    ...
    def get(self, collection_id: str) -> Optional[MusicCollection | MusicCollectionUI]:
        """
    ...
    def get_default(self) -> Optional[MusicCollection | MusicCollectionUI]:
        """
    ...
    def get_info(self, collection_id: str) -> Optional[dict]:
        """
