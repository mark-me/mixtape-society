...
Combine digital convenience with physical charm:

### QR Code Card

1. Download the enhanced QR code (with cover art and title)
2. Print it on cardstock
3. Include it in a greeting card or gift package
4. Recipient scans with their phone to access the mixtape
...
- Instructions for casting to Chromecast
...
- Everyone contributes to the atmosphere
...
Recipients can adjust audio quality to match their connection:

- **Original** – Full quality, highest bandwidth
- **High (256k)** – Great quality, moderate bandwidth
- **Medium (192k)** – Good quality, lower bandwidth *(default)*
